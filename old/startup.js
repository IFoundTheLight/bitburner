...
const filesToCopy = ["startup.js", "remoteexec.js", "launcher.js"];
...
export async function main(ns)
{
  ...
  for (var i = 0; i < connectedHosts.length; i++)
  {
    ...
    if (hostName != remoteHost)
    {
      ...
      // 
      await ns.run("launcher.js", 1, remoteHost);

      //
      await ns.tprint(`[${hostName}] (startup) Remote runing Startup Script ${remoteHost}`);
    }
  }
}